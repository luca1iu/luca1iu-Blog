...
export const getServerSideProps = async ctx => {
  ...
  for (let index = 0; index < siteIds.length; index++) {
    ...
    const localeFields = generateGoogleSitemap(link, siteData.allPages, locale)
...
function generateGoogleSitemap(link, allPages, locale) {
  // 确保链接不以斜杠结尾
