...
export const getServerSideProps = async ctx => {
  ...
  for (let index = 0; index < siteIds.length; index++) {
    ...
    const localeFields = generateBingSitemap(link, siteData.allPages, locale)
...
function generateBingSitemap(link, allPages, locale) {
  // 确保链接不以斜杠结尾
