...
module.exports = {
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    '/styles/prism-vsc-dark-plus.css', // 代码块默认主题 - VSCode Dark Plus
  ...
  PRISM_THEME_LIGHT_PATH:
    ...
    '/styles/prism-vsc-dark-plus.css', // 浅色模式主题 - 统一使用 VSCode Dark Plus
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    '/styles/prism-vsc-dark-plus.css', // 深色模式主题 - 统一使用 VSCode Dark Plus
